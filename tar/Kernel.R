...
for (i in 2013:2013) {
  for (j in 10:10) {
    ...
    for (rowPivot in 1:(num_of_cols )) {
      ...
      outputFileName = paste("~/Desktop/", as.character(m), "_", as.character(rowPivot), ".jpg", sep="")
      ...
      dev.off()
      outputmatrixname = paste("~/Desktop/", as.character(m), "_", as.character(rowPivot), ".txt", sep="")
